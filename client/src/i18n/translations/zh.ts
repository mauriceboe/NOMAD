const zh: Record<string, string> = {
  ...
  // Storage
  'admin.storage.title': '存储目标',
  'admin.storage.description': '配置外部存储后端用于备份、文件和媒体',
  'admin.storage.addTarget': '添加存储目标',
  'admin.storage.editTarget': '编辑存储目标',
  'admin.storage.name': '名称',
  'admin.storage.type': '类型',
  'admin.storage.status': '状态',
  'admin.storage.encryption': '加密',
  'admin.storage.enabled': '已启用',
  'admin.storage.disabled': '已禁用',
  'admin.storage.encrypted': '已加密',
  'admin.storage.unencrypted': '未加密',
  'admin.storage.test': '测试',
  'admin.storage.testing': '测试中...',
  'admin.storage.testSuccess': '连接成功',
  'admin.storage.testFailed': '连接失败',
  'admin.storage.confirmDelete': '删除存储目标"{name}"？如果目标当前已分配，此操作将失败。',
  'admin.storage.noTargets': '未配置存储目标',
  'admin.storage.bucket': 'S3存储桶',
  'admin.storage.region': '区域',
  'admin.storage.endpoint': '自定义端点',
  'admin.storage.endpointHelp': '用于S3兼容服务，如MinIO、Wasabi或Backblaze B2',
  'admin.storage.accessKeyId': '访问密钥ID',
  'admin.storage.secretAccessKey': '秘密访问密钥',
  'admin.storage.leaveBlankToKeep': '留空以保留当前值',
  'admin.storage.pathPrefix': '路径前缀',
  'admin.storage.usePresignedUrls': '使用预签名URL进行下载',
  'admin.storage.encryptAtRest': '静态加密文件（AES-256-GCM）',
  'admin.storage.assignments': '存储分配',
  'admin.storage.assignmentsDescription': '将存储目标分配给不同用途',
  'admin.storage.purpose': '用途',
  'admin.storage.currentTarget': '当前目标',
  'admin.storage.assignTarget': '分配目标',
  'admin.storage.localStorage': '本地存储',
  'admin.storage.purpose_backup': '备份',
  'admin.storage.purpose_backup_desc': '自动和手动备份文件',
  'admin.storage.purpose_photos': '照片',
  'admin.storage.purpose_photos_desc': '旅行照片和图片',
  'admin.storage.purpose_files': '文件',
  'admin.storage.purpose_files_desc': '旅行文档和附件',
  'admin.storage.purpose_covers': '封面图片',
  'admin.storage.purpose_covers_desc': '旅行封面照片',
  'admin.storage.purpose_avatars': '头像',
  'admin.storage.purpose_avatars_desc': '用户个人资料图片',
  'admin.storage.assignmentsNote': '重要',
  'admin.storage.assignmentsNoteText': '更改存储分配仅影响新上传。现有文件保留在其当前位置。',
  'admin.storage.applyToAll': '应用于所有用途',
  'admin.storage.applyToAllBtn': '应用',
  'admin.storage.applyToAllSuccess': '存储目标已应用于所有用途',
