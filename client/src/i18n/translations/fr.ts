const fr: Record<string, string> = {
  ...
  // Storage
  'admin.storage.title': 'Cibles de stockage',
  'admin.storage.description': 'Configurer les backends de stockage externes pour les sauvegardes, fichiers et médias',
  'admin.storage.addTarget': 'Ajouter une cible de stockage',
  'admin.storage.editTarget': 'Modifier la cible de stockage',
  'admin.storage.name': 'Nom',
  'admin.storage.type': 'Type',
  'admin.storage.status': 'Statut',
  'admin.storage.encryption': 'Chiffrement',
  'admin.storage.enabled': 'Activé',
  'admin.storage.disabled': 'Désactivé',
  'admin.storage.encrypted': 'Chiffré',
  'admin.storage.unencrypted': 'Non chiffré',
  'admin.storage.test': 'Tester',
  'admin.storage.testing': 'Test en cours...',
  'admin.storage.testSuccess': 'Connexion réussie',
  'admin.storage.testFailed': 'Échec de la connexion',
  'admin.storage.confirmDelete': 'Supprimer la cible de stockage "{name}" ? Cela échouera si la cible est actuellement assignée.',
  'admin.storage.noTargets': 'Aucune cible de stockage configurée',
  'admin.storage.bucket': 'Bucket S3',
  'admin.storage.region': 'Région',
  'admin.storage.endpoint': 'Point de terminaison personnalisé',
  'admin.storage.endpointHelp': 'Pour les services compatibles S3 comme MinIO, Wasabi ou Backblaze B2',
  'admin.storage.accessKeyId': 'ID de clé d\'accès',
  'admin.storage.secretAccessKey': 'Clé d\'accès secrète',
  'admin.storage.leaveBlankToKeep': 'laisser vide pour conserver l\'actuel',
  'admin.storage.pathPrefix': 'Préfixe de chemin',
  'admin.storage.usePresignedUrls': 'Utiliser des URL présignées pour les téléchargements',
  'admin.storage.encryptAtRest': 'Chiffrer les fichiers au repos (AES-256-GCM)',
  'admin.storage.assignments': 'Affectations de stockage',
  'admin.storage.assignmentsDescription': 'Affecter des cibles de stockage à différents usages',
  'admin.storage.purpose': 'Usage',
  'admin.storage.currentTarget': 'Cible actuelle',
  'admin.storage.assignTarget': 'Affecter une cible',
  'admin.storage.localStorage': 'Stockage local',
  'admin.storage.purpose_backup': 'Sauvegardes',
  'admin.storage.purpose_backup_desc': 'Fichiers de sauvegarde automatiques et manuels',
  'admin.storage.purpose_photos': 'Photos',
  'admin.storage.purpose_photos_desc': 'Photos et images de voyage',
  'admin.storage.purpose_files': 'Fichiers',
  'admin.storage.purpose_files_desc': 'Documents et pièces jointes de voyage',
  'admin.storage.purpose_covers': 'Images de couverture',
  'admin.storage.purpose_covers_desc': 'Photos de couverture de voyage',
  'admin.storage.purpose_avatars': 'Avatars',
  'admin.storage.purpose_avatars_desc': 'Photos de profil utilisateur',
  'admin.storage.assignmentsNote': 'Important',
  'admin.storage.assignmentsNoteText': 'La modification des affectations de stockage n\'affecte que les nouveaux téléchargements. Les fichiers existants restent à leur emplacement actuel.',
  'admin.storage.applyToAll': 'Appliquer à tous les usages',
  'admin.storage.applyToAllBtn': 'Appliquer',
  'admin.storage.applyToAllSuccess': 'Destination de stockage appliquée à tous les usages',
