const ru: Record<string, string> = {
  ...
  // Storage
  'admin.storage.title': 'Цели хранения',
  'admin.storage.description': 'Настройка внешних бэкендов хранения для резервных копий, файлов и медиа',
  'admin.storage.addTarget': 'Добавить цель хранения',
  'admin.storage.editTarget': 'Редактировать цель хранения',
  'admin.storage.name': 'Имя',
  'admin.storage.type': 'Тип',
  'admin.storage.status': 'Статус',
  'admin.storage.encryption': 'Шифрование',
  'admin.storage.enabled': 'Включено',
  'admin.storage.disabled': 'Отключено',
  'admin.storage.encrypted': 'Зашифровано',
  'admin.storage.unencrypted': 'Не зашифровано',
  'admin.storage.test': 'Тест',
  'admin.storage.testing': 'Тестирование...',
  'admin.storage.testSuccess': 'Подключение успешно',
  'admin.storage.testFailed': 'Подключение не удалось',
  'admin.storage.confirmDelete': 'Удалить цель хранения "{name}"? Это не удастся, если цель в данный момент назначена.',
  'admin.storage.noTargets': 'Цели хранения не настроены',
  'admin.storage.bucket': 'S3 Bucket',
  'admin.storage.region': 'Регион',
  'admin.storage.endpoint': 'Пользовательская конечная точка',
  'admin.storage.endpointHelp': 'Для сервисов, совместимых с S3, таких как MinIO, Wasabi или Backblaze B2',
  'admin.storage.accessKeyId': 'ID ключа доступа',
  'admin.storage.secretAccessKey': 'Секретный ключ доступа',
  'admin.storage.leaveBlankToKeep': 'оставьте пустым, чтобы сохранить текущий',
  'admin.storage.pathPrefix': 'Префикс пути',
  'admin.storage.usePresignedUrls': 'Использовать предподписанные URL для загрузок',
  'admin.storage.encryptAtRest': 'Шифровать файлы в покое (AES-256-GCM)',
  'admin.storage.assignments': 'Назначения хранилища',
  'admin.storage.assignmentsDescription': 'Назначить цели хранения различным целям',
  'admin.storage.purpose': 'Цель',
  'admin.storage.currentTarget': 'Текущая цель',
  'admin.storage.assignTarget': 'Назначить цель',
  'admin.storage.localStorage': 'Локальное хранилище',
  'admin.storage.purpose_backup': 'Резервные копии',
  'admin.storage.purpose_backup_desc': 'Автоматические и ручные файлы резервных копий',
  'admin.storage.purpose_photos': 'Фотографии',
  'admin.storage.purpose_photos_desc': 'Фотографии и изображения путешествий',
  'admin.storage.purpose_files': 'Файлы',
  'admin.storage.purpose_files_desc': 'Документы и вложения путешествий',
  'admin.storage.purpose_covers': 'Обложки',
  'admin.storage.purpose_covers_desc': 'Фотографии обложек путешествий',
  'admin.storage.purpose_avatars': 'Аватары',
  'admin.storage.purpose_avatars_desc': 'Изображения профилей пользователей',
  'admin.storage.assignmentsNote': 'Важно',
  'admin.storage.assignmentsNoteText': 'Изменение назначений хранилища влияет только на новые загрузки. Существующие файлы остаются в своем текущем местоположении.',
  'admin.storage.applyToAll': 'Применить ко всем целям',
  'admin.storage.applyToAllBtn': 'Применить',
  'admin.storage.applyToAllSuccess': 'Цель хранилища применена ко всем целям',
