const hu: Record<string, string | { name: string; category: string }[]> = {
  ...
  // Storage
  'admin.tabs.storage': 'Tárolás',

  // Storage
  'admin.storage.title': 'Tárolási célok',
  'admin.storage.description': 'Külső tárolási háttérrendszerek konfigurálása biztonsági mentésekhez, fájlokhoz és médiához',
  'admin.storage.addTarget': 'Tárolási cél hozzáadása',
  'admin.storage.editTarget': 'Tárolási cél szerkesztése',
  'admin.storage.name': 'Név',
  'admin.storage.type': 'Típus',
  'admin.storage.status': 'Állapot',
  'admin.storage.encryption': 'Titkosítás',
  'admin.storage.enabled': 'Engedélyezve',
  'admin.storage.disabled': 'Letiltva',
  'admin.storage.encrypted': 'Titkosított',
  'admin.storage.unencrypted': 'Titkosítatlan',
  'admin.storage.test': 'Teszt',
  'admin.storage.testing': 'Tesztelés...',
  'admin.storage.testSuccess': 'Sikeres kapcsolat',
  'admin.storage.testFailed': 'Sikertelen kapcsolat',
  'admin.storage.confirmDelete': 'Törli a(z) "{name}" tárolási célt? Ez sikertelen lesz, ha a cél jelenleg hozzá van rendelve.',
  'admin.storage.noTargets': 'Nincsenek konfigurált tárolási célok',
  'admin.storage.bucket': 'S3 Bucket',
  'admin.storage.region': 'Régió',
  'admin.storage.endpoint': 'Egyéni végpont',
  'admin.storage.endpointHelp': 'S3-kompatibilis szolgáltatásokhoz, mint a MinIO, Wasabi vagy Backblaze B2',
  'admin.storage.accessKeyId': 'Hozzáférési kulcs azonosító',
  'admin.storage.secretAccessKey': 'Titkos hozzáférési kulcs',
  'admin.storage.leaveBlankToKeep': 'hagyja üresen a jelenlegi megtartásához',
  'admin.storage.pathPrefix': 'Útvonal előtag',
  'admin.storage.usePresignedUrls': 'Előre aláírt URL-ek használata letöltésekhez',
  'admin.storage.encryptAtRest': 'Fájlok titkosítása nyugalmi állapotban (AES-256-GCM)',
  'admin.storage.assignments': 'Tárolási hozzárendelések',
  'admin.storage.assignmentsDescription': 'Tárolási célok hozzárendelése különböző célokhoz',
  'admin.storage.purpose': 'Cél',
  'admin.storage.currentTarget': 'Jelenlegi cél',
  'admin.storage.assignTarget': 'Cél hozzárendelése',
  'admin.storage.localStorage': 'Helyi tárolás',
  'admin.storage.purpose_backup': 'Biztonsági mentések',
  'admin.storage.purpose_backup_desc': 'Automatikus és manuális biztonsági mentési fájlok',
  'admin.storage.purpose_photos': 'Fényképek',
  'admin.storage.purpose_photos_desc': 'Utazási fényképek és képek',
  'admin.storage.purpose_files': 'Fájlok',
  'admin.storage.purpose_files_desc': 'Utazási dokumentumok és mellékletek',
  'admin.storage.purpose_covers': 'Borítóképek',
  'admin.storage.purpose_covers_desc': 'Utazási borítófotók',
  'admin.storage.purpose_avatars': 'Avatarok',
  'admin.storage.purpose_avatars_desc': 'Felhasználói profilképek',
  'admin.storage.assignmentsNote': 'Fontos',
  'admin.storage.assignmentsNoteText': 'A tárolási hozzárendelések módosítása csak az új feltöltéseket érinti. A meglévő fájlok a jelenlegi helyükön maradnak.',
  'admin.storage.applyToAll': 'Alkalmazás az összes célra',
  'admin.storage.applyToAllBtn': 'Alkalmazás',
  'admin.storage.applyToAllSuccess': 'A tárolási cél az összes célhoz alkalmazva',
