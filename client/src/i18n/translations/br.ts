const br: Record<string, string | { name: string; category: string }[]> = {
  ...
  // Storage
  'admin.storage.title': 'Destinos de armazenamento',
  'admin.storage.description': 'Configurar backends de armazenamento externos para backups, arquivos e mídia',
  'admin.storage.addTarget': 'Adicionar destino de armazenamento',
  'admin.storage.editTarget': 'Editar destino de armazenamento',
  'admin.storage.name': 'Nome',
  'admin.storage.type': 'Tipo',
  'admin.storage.status': 'Status',
  'admin.storage.encryption': 'Criptografia',
  'admin.storage.enabled': 'Ativado',
  'admin.storage.disabled': 'Desativado',
  'admin.storage.encrypted': 'Criptografado',
  'admin.storage.unencrypted': 'Não criptografado',
  'admin.storage.test': 'Testar',
  'admin.storage.testing': 'Testando...',
  'admin.storage.testSuccess': 'Conexão bem-sucedida',
  'admin.storage.testFailed': 'Falha na conexão',
  'admin.storage.confirmDelete': 'Excluir destino de armazenamento "{name}"? Isso falhará se o destino estiver atualmente atribuído.',
  'admin.storage.noTargets': 'Nenhum destino de armazenamento configurado',
  'admin.storage.bucket': 'Bucket S3',
  'admin.storage.region': 'Região',
  'admin.storage.endpoint': 'Endpoint personalizado',
  'admin.storage.endpointHelp': 'Para serviços compatíveis com S3 como MinIO, Wasabi ou Backblaze B2',
  'admin.storage.accessKeyId': 'ID da chave de acesso',
  'admin.storage.secretAccessKey': 'Chave de acesso secreta',
  'admin.storage.leaveBlankToKeep': 'deixe em branco para manter o atual',
  'admin.storage.pathPrefix': 'Prefixo de caminho',
  'admin.storage.usePresignedUrls': 'Usar URLs pré-assinadas para downloads',
  'admin.storage.encryptAtRest': 'Criptografar arquivos em repouso (AES-256-GCM)',
  'admin.storage.assignments': 'Atribuições de armazenamento',
  'admin.storage.assignmentsDescription': 'Atribuir destinos de armazenamento a diferentes finalidades',
  'admin.storage.purpose': 'Finalidade',
  'admin.storage.currentTarget': 'Destino atual',
  'admin.storage.assignTarget': 'Atribuir destino',
  'admin.storage.localStorage': 'Armazenamento local',
  'admin.storage.purpose_backup': 'Backups',
  'admin.storage.purpose_backup_desc': 'Arquivos de backup automáticos e manuais',
  'admin.storage.purpose_photos': 'Fotos',
  'admin.storage.purpose_photos_desc': 'Fotos e imagens de viagem',
  'admin.storage.purpose_files': 'Arquivos',
  'admin.storage.purpose_files_desc': 'Documentos e anexos de viagem',
  'admin.storage.purpose_covers': 'Imagens de capa',
  'admin.storage.purpose_covers_desc': 'Fotos de capa de viagem',
  'admin.storage.purpose_avatars': 'Avatares',
  'admin.storage.purpose_avatars_desc': 'Fotos de perfil de usuário',
  'admin.storage.assignmentsNote': 'Importante',
  'admin.storage.assignmentsNoteText': 'Alterar atribuições de armazenamento afeta apenas novos uploads. Arquivos existentes permanecem em sua localização atual.',
  'admin.storage.applyToAll': 'Aplicar a todas as finalidades',
  'admin.storage.applyToAllBtn': 'Aplicar',
  'admin.storage.applyToAllSuccess': 'Destino de armazenamento aplicado a todas as finalidades',
