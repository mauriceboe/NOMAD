const cs: Record<string, string | { name: string; category: string }[]> = {
  ...
  // Storage
  'admin.storage.title': 'Cíle úložiště',
  'admin.storage.description': 'Konfigurace externích backendů úložiště pro zálohy, soubory a média',
  'admin.storage.addTarget': 'Přidat cíl úložiště',
  'admin.storage.editTarget': 'Upravit cíl úložiště',
  'admin.storage.name': 'Název',
  'admin.storage.type': 'Typ',
  'admin.storage.status': 'Stav',
  'admin.storage.encryption': 'Šifrování',
  'admin.storage.enabled': 'Povoleno',
  'admin.storage.disabled': 'Zakázáno',
  'admin.storage.encrypted': 'Šifrováno',
  'admin.storage.unencrypted': 'Nešifrováno',
  'admin.storage.test': 'Test',
  'admin.storage.testing': 'Testování...',
  'admin.storage.testSuccess': 'Připojení úspěšné',
  'admin.storage.testFailed': 'Připojení selhalo',
  'admin.storage.confirmDelete': 'Smazat cíl úložiště "{name}"? Toto selže, pokud je cíl aktuálně přiřazen.',
  'admin.storage.noTargets': 'Nejsou nakonfigurovány žádné cíle úložiště',
  'admin.storage.bucket': 'S3 Bucket',
  'admin.storage.region': 'Region',
  'admin.storage.endpoint': 'Vlastní endpoint',
  'admin.storage.endpointHelp': 'Pro služby kompatibilní s S3 jako MinIO, Wasabi nebo Backblaze B2',
  'admin.storage.accessKeyId': 'ID přístupového klíče',
  'admin.storage.secretAccessKey': 'Tajný přístupový klíč',
  'admin.storage.leaveBlankToKeep': 'ponechte prázdné pro zachování aktuálního',
  'admin.storage.pathPrefix': 'Prefix cesty',
  'admin.storage.usePresignedUrls': 'Použít předpodepsané URL pro stahování',
  'admin.storage.encryptAtRest': 'Šifrovat soubory v klidu (AES-256-GCM)',
  'admin.storage.assignments': 'Přiřazení úložiště',
  'admin.storage.assignmentsDescription': 'Přiřadit cíle úložiště různým účelům',
  'admin.storage.purpose': 'Účel',
  'admin.storage.currentTarget': 'Aktuální cíl',
  'admin.storage.assignTarget': 'Přiřadit cíl',
  'admin.storage.localStorage': 'Místní úložiště',
  'admin.storage.purpose_backup': 'Zálohy',
  'admin.storage.purpose_backup_desc': 'Automatické a manuální záložní soubory',
  'admin.storage.purpose_photos': 'Fotografie',
  'admin.storage.purpose_photos_desc': 'Fotografie a obrázky z cest',
  'admin.storage.purpose_files': 'Soubory',
  'admin.storage.purpose_files_desc': 'Dokumenty a přílohy cest',
  'admin.storage.purpose_covers': 'Obrázky obálek',
  'admin.storage.purpose_covers_desc': 'Fotografie obálek cest',
  'admin.storage.purpose_avatars': 'Avatary',
  'admin.storage.purpose_avatars_desc': 'Profilové obrázky uživatelů',
  'admin.storage.assignmentsNote': 'Důležité',
  'admin.storage.assignmentsNoteText': 'Změna přiřazení úložiště ovlivňuje pouze nová nahrání. Existující soubory zůstávají na svém aktuálním místě.',
  'admin.storage.applyToAll': 'Použít pro všechny účely',
  'admin.storage.applyToAllBtn': 'Použít',
  'admin.storage.applyToAllSuccess': 'Cíl úložiště byl použit pro všechny účely',
