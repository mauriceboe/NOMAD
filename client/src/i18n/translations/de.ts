const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  // Storage
  'admin.storage.title': 'Speicherziele',
  'admin.storage.description': 'Externe Speicher-Backends für Backups, Dateien und Medien konfigurieren',
  'admin.storage.addTarget': 'Speicherziel hinzufügen',
  'admin.storage.editTarget': 'Speicherziel bearbeiten',
  'admin.storage.name': 'Name',
  'admin.storage.type': 'Typ',
  'admin.storage.status': 'Status',
  'admin.storage.encryption': 'Verschlüsselung',
  'admin.storage.enabled': 'Aktiviert',
  'admin.storage.disabled': 'Deaktiviert',
  'admin.storage.encrypted': 'Verschlüsselt',
  'admin.storage.unencrypted': 'Unverschlüsselt',
  'admin.storage.test': 'Testen',
  'admin.storage.testing': 'Teste...',
  'admin.storage.testSuccess': 'Verbindung erfolgreich',
  'admin.storage.testFailed': 'Verbindung fehlgeschlagen',
  'admin.storage.confirmDelete': 'Speicherziel "{name}" löschen? Dies schlägt fehl, wenn das Ziel derzeit zugewiesen ist.',
  'admin.storage.noTargets': 'Keine Speicherziele konfiguriert',
  'admin.storage.bucket': 'S3-Bucket',
  'admin.storage.region': 'Region',
  'admin.storage.endpoint': 'Benutzerdefinierter Endpunkt',
  'admin.storage.endpointHelp': 'Für S3-kompatible Dienste wie MinIO, Wasabi oder Backblaze B2',
  'admin.storage.accessKeyId': 'Zugriffsschlüssel-ID',
  'admin.storage.secretAccessKey': 'Geheimer Zugriffsschlüssel',
  'admin.storage.leaveBlankToKeep': 'leer lassen, um aktuellen beizubehalten',
  'admin.storage.pathPrefix': 'Pfadpräfix',
  'admin.storage.usePresignedUrls': 'Vorsignierte URLs für Downloads verwenden',
  'admin.storage.encryptAtRest': 'Dateien im Ruhezustand verschlüsseln (AES-256-GCM)',
  'admin.storage.assignments': 'Speicherzuweisungen',
  'admin.storage.assignmentsDescription': 'Speicherziele verschiedenen Zwecken zuweisen',
  'admin.storage.purpose': 'Zweck',
  'admin.storage.currentTarget': 'Aktuelles Ziel',
  'admin.storage.assignTarget': 'Ziel zuweisen',
  'admin.storage.localStorage': 'Lokaler Speicher',
  'admin.storage.purpose_backup': 'Backups',
  'admin.storage.purpose_backup_desc': 'Automatische und manuelle Backup-Dateien',
  'admin.storage.purpose_photos': 'Fotos',
  'admin.storage.purpose_photos_desc': 'Reisefotos und Bilder',
  'admin.storage.purpose_files': 'Dateien',
  'admin.storage.purpose_files_desc': 'Reisedokumente und Anhänge',
  'admin.storage.purpose_covers': 'Titelbilder',
  'admin.storage.purpose_covers_desc': 'Reise-Titelfotos',
  'admin.storage.purpose_avatars': 'Avatare',
  'admin.storage.purpose_avatars_desc': 'Benutzerprofilbilder',
  'admin.storage.assignmentsNote': 'Wichtig',
  'admin.storage.assignmentsNoteText': 'Das Ändern von Speicherzuweisungen betrifft nur neue Uploads. Vorhandene Dateien bleiben an ihrem aktuellen Speicherort.',
  'admin.storage.applyToAll': 'Auf alle Zwecke anwenden',
  'admin.storage.applyToAllBtn': 'Anwenden',
  'admin.storage.applyToAllSuccess': 'Speicherziel auf alle Zwecke angewendet',
