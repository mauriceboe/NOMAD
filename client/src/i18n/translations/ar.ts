...
const ar: Record<string, string | { name: string; category: string }[]> = {
  ...
  // Storage
  'admin.storage.title': 'أهداف التخزين',
  'admin.storage.description': 'تكوين خلفيات التخزين الخارجية للنسخ الاحتياطية والملفات والوسائط',
  'admin.storage.addTarget': 'إضافة هدف تخزين',
  'admin.storage.editTarget': 'تعديل هدف التخزين',
  'admin.storage.name': 'الاسم',
  'admin.storage.type': 'النوع',
  'admin.storage.status': 'الحالة',
  'admin.storage.encryption': 'التشفير',
  'admin.storage.enabled': 'مفعّل',
  'admin.storage.disabled': 'معطّل',
  'admin.storage.encrypted': 'مشفّر',
  'admin.storage.unencrypted': 'غير مشفّر',
  'admin.storage.test': 'اختبار',
  'admin.storage.testing': 'جارٍ الاختبار...',
  'admin.storage.testSuccess': 'نجح الاتصال',
  'admin.storage.testFailed': 'فشل الاتصال',
  'admin.storage.confirmDelete': 'حذف هدف التخزين "{name}"؟ سيفشل هذا إذا كان الهدف مخصصًا حاليًا.',
  'admin.storage.noTargets': 'لم يتم تكوين أهداف تخزين',
  'admin.storage.bucket': 'حاوية S3',
  'admin.storage.region': 'المنطقة',
  'admin.storage.endpoint': 'نقطة نهاية مخصصة',
  'admin.storage.endpointHelp': 'للخدمات المتوافقة مع S3 مثل MinIO أو Wasabi أو Backblaze B2',
  'admin.storage.accessKeyId': 'معرّف مفتاح الوصول',
  'admin.storage.secretAccessKey': 'مفتاح الوصول السري',
  'admin.storage.leaveBlankToKeep': 'اتركه فارغًا للاحتفاظ بالحالي',
  'admin.storage.pathPrefix': 'بادئة المسار',
  'admin.storage.usePresignedUrls': 'استخدام عناوين URL موقعة مسبقًا للتنزيلات',
  'admin.storage.encryptAtRest': 'تشفير الملفات في وضع السكون (AES-256-GCM)',
  'admin.storage.assignments': 'تخصيصات التخزين',
  'admin.storage.assignmentsDescription': 'تخصيص أهداف التخزين لأغراض مختلفة',
  'admin.storage.purpose': 'الغرض',
  'admin.storage.currentTarget': 'الهدف الحالي',
  'admin.storage.assignTarget': 'تخصيص هدف',
  'admin.storage.localStorage': 'التخزين المحلي',
  'admin.storage.purpose_backup': 'النسخ الاحتياطية',
  'admin.storage.purpose_backup_desc': 'ملفات النسخ الاحتياطي التلقائية واليدوية',
  'admin.storage.purpose_photos': 'الصور',
  'admin.storage.purpose_photos_desc': 'صور الرحلات والصور',
  'admin.storage.purpose_files': 'الملفات',
  'admin.storage.purpose_files_desc': 'مستندات الرحلات والمرفقات',
  'admin.storage.purpose_covers': 'صور الغلاف',
  'admin.storage.purpose_covers_desc': 'صور غلاف الرحلات',
  'admin.storage.purpose_avatars': 'الصور الرمزية',
  'admin.storage.purpose_avatars_desc': 'صور ملفات تعريف المستخدمين',
  'admin.storage.assignmentsNote': 'مهم',
  'admin.storage.assignmentsNoteText': 'تغيير تخصيصات التخزين يؤثر فقط على التحميلات الجديدة. تبقى الملفات الموجودة في موقعها الحالي.',
  'admin.storage.applyToAll': 'تطبيق على جميع الأغراض',
  'admin.storage.applyToAllBtn': 'تطبيق',
  'admin.storage.applyToAllSuccess': 'تم تطبيق هدف التخزين على جميع الأغراض',
