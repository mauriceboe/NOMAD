const it: Record<string, string | { name: string; category: string }[]> = {
  ...
  // Storage
  'admin.storage.title': 'Destinazioni di archiviazione',
  'admin.storage.description': 'Configura backend di archiviazione esterni per backup, file e media',
  'admin.storage.addTarget': 'Aggiungi destinazione di archiviazione',
  'admin.storage.editTarget': 'Modifica destinazione di archiviazione',
  'admin.storage.name': 'Nome',
  'admin.storage.type': 'Tipo',
  'admin.storage.status': 'Stato',
  'admin.storage.encryption': 'Crittografia',
  'admin.storage.enabled': 'Abilitato',
  'admin.storage.disabled': 'Disabilitato',
  'admin.storage.encrypted': 'Crittografato',
  'admin.storage.unencrypted': 'Non crittografato',
  'admin.storage.test': 'Test',
  'admin.storage.testing': 'Test in corso...',
  'admin.storage.testSuccess': 'Connessione riuscita',
  'admin.storage.testFailed': 'Connessione fallita',
  'admin.storage.confirmDelete': 'Eliminare la destinazione di archiviazione "{name}"? Questo fallirà se la destinazione è attualmente assegnata.',
  'admin.storage.noTargets': 'Nessuna destinazione di archiviazione configurata',
  'admin.storage.bucket': 'Bucket S3',
  'admin.storage.region': 'Regione',
  'admin.storage.endpoint': 'Endpoint personalizzato',
  'admin.storage.endpointHelp': 'Per servizi compatibili con S3 come MinIO, Wasabi o Backblaze B2',
  'admin.storage.accessKeyId': 'ID chiave di accesso',
  'admin.storage.secretAccessKey': 'Chiave di accesso segreta',
  'admin.storage.leaveBlankToKeep': 'lascia vuoto per mantenere quello attuale',
  'admin.storage.pathPrefix': 'Prefisso percorso',
  'admin.storage.usePresignedUrls': 'Usa URL prefirmati per i download',
  'admin.storage.encryptAtRest': 'Crittografa file a riposo (AES-256-GCM)',
  'admin.storage.assignments': 'Assegnazioni di archiviazione',
  'admin.storage.assignmentsDescription': 'Assegna destinazioni di archiviazione a scopi diversi',
  'admin.storage.purpose': 'Scopo',
  'admin.storage.currentTarget': 'Destinazione attuale',
  'admin.storage.assignTarget': 'Assegna destinazione',
  'admin.storage.localStorage': 'Archiviazione locale',
  'admin.storage.purpose_backup': 'Backup',
  'admin.storage.purpose_backup_desc': 'File di backup automatici e manuali',
  'admin.storage.purpose_photos': 'Foto',
  'admin.storage.purpose_photos_desc': 'Foto e immagini di viaggio',
  'admin.storage.purpose_files': 'File',
  'admin.storage.purpose_files_desc': 'Documenti e allegati di viaggio',
  'admin.storage.purpose_covers': 'Immagini di copertina',
  'admin.storage.purpose_covers_desc': 'Foto di copertina del viaggio',
  'admin.storage.purpose_avatars': 'Avatar',
  'admin.storage.purpose_avatars_desc': 'Immagini del profilo utente',
  'admin.storage.assignmentsNote': 'Importante',
  'admin.storage.assignmentsNoteText': 'La modifica delle assegnazioni di archiviazione influisce solo sui nuovi caricamenti. I file esistenti rimangono nella loro posizione attuale.',
  'admin.storage.applyToAll': 'Applica a tutte le finalità',
  'admin.storage.applyToAllBtn': 'Applica',
  'admin.storage.applyToAllSuccess': 'Destinazione di archiviazione applicata a tutte le finalità',
