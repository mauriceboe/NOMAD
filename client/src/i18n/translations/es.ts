const es: Record<string, string> = {
  ...
  // Storage
  'admin.storage.title': 'Destinos de almacenamiento',
  'admin.storage.description': 'Configurar backends de almacenamiento externos para copias de seguridad, archivos y medios',
  'admin.storage.addTarget': 'Añadir destino de almacenamiento',
  'admin.storage.editTarget': 'Editar destino de almacenamiento',
  'admin.storage.name': 'Nombre',
  'admin.storage.type': 'Tipo',
  'admin.storage.status': 'Estado',
  'admin.storage.encryption': 'Cifrado',
  'admin.storage.enabled': 'Activado',
  'admin.storage.disabled': 'Desactivado',
  'admin.storage.encrypted': 'Cifrado',
  'admin.storage.unencrypted': 'Sin cifrar',
  'admin.storage.test': 'Probar',
  'admin.storage.testing': 'Probando...',
  'admin.storage.testSuccess': 'Conexión exitosa',
  'admin.storage.testFailed': 'Conexión fallida',
  'admin.storage.confirmDelete': '¿Eliminar destino de almacenamiento "{name}"? Esto fallará si el destino está actualmente asignado.',
  'admin.storage.noTargets': 'No hay destinos de almacenamiento configurados',
  'admin.storage.bucket': 'Bucket S3',
  'admin.storage.region': 'Región',
  'admin.storage.endpoint': 'Endpoint personalizado',
  'admin.storage.endpointHelp': 'Para servicios compatibles con S3 como MinIO, Wasabi o Backblaze B2',
  'admin.storage.accessKeyId': 'ID de clave de acceso',
  'admin.storage.secretAccessKey': 'Clave de acceso secreta',
  'admin.storage.leaveBlankToKeep': 'dejar en blanco para mantener el actual',
  'admin.storage.pathPrefix': 'Prefijo de ruta',
  'admin.storage.usePresignedUrls': 'Usar URLs prefirmadas para descargas',
  'admin.storage.encryptAtRest': 'Cifrar archivos en reposo (AES-256-GCM)',
  'admin.storage.assignments': 'Asignaciones de almacenamiento',
  'admin.storage.assignmentsDescription': 'Asignar destinos de almacenamiento a diferentes propósitos',
  'admin.storage.purpose': 'Propósito',
  'admin.storage.currentTarget': 'Destino actual',
  'admin.storage.assignTarget': 'Asignar destino',
  'admin.storage.localStorage': 'Almacenamiento local',
  'admin.storage.purpose_backup': 'Copias de seguridad',
  'admin.storage.purpose_backup_desc': 'Archivos de copia de seguridad automáticos y manuales',
  'admin.storage.purpose_photos': 'Fotos',
  'admin.storage.purpose_photos_desc': 'Fotos e imágenes de viaje',
  'admin.storage.purpose_files': 'Archivos',
  'admin.storage.purpose_files_desc': 'Documentos y adjuntos de viaje',
  'admin.storage.purpose_covers': 'Imágenes de portada',
  'admin.storage.purpose_covers_desc': 'Fotos de portada de viaje',
  'admin.storage.purpose_avatars': 'Avatares',
  'admin.storage.purpose_avatars_desc': 'Fotos de perfil de usuario',
  'admin.storage.assignmentsNote': 'Importante',
  'admin.storage.assignmentsNoteText': 'Cambiar las asignaciones de almacenamiento solo afecta a las nuevas cargas. Los archivos existentes permanecen en su ubicación actual.',
  'admin.storage.applyToAll': 'Aplicar a todas las finalidades',
  'admin.storage.applyToAllBtn': 'Aplicar',
  'admin.storage.applyToAllSuccess': 'Destino de almacenamiento aplicado a todas las finalidades',
