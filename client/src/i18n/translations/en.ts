const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  // Storage
  'admin.storage.title': 'Storage Targets',
  'admin.storage.description': 'Configure external storage backends for backups, files, and media',
  'admin.storage.addTarget': 'Add Storage Target',
  'admin.storage.editTarget': 'Edit Storage Target',
  'admin.storage.name': 'Name',
  'admin.storage.type': 'Type',
  'admin.storage.status': 'Status',
  'admin.storage.encryption': 'Encryption',
  'admin.storage.enabled': 'Enabled',
  'admin.storage.disabled': 'Disabled',
  'admin.storage.encrypted': 'Encrypted',
  'admin.storage.unencrypted': 'Unencrypted',
  'admin.storage.test': 'Test',
  'admin.storage.testing': 'Testing...',
  'admin.storage.testSuccess': 'Connection successful',
  'admin.storage.testFailed': 'Connection failed',
  'admin.storage.confirmDelete': 'Delete storage target "{name}"? This will fail if the target is currently assigned.',
  'admin.storage.noTargets': 'No storage targets configured',
  'admin.storage.bucket': 'S3 Bucket',
  'admin.storage.region': 'Region',
  'admin.storage.endpoint': 'Custom Endpoint',
  'admin.storage.endpointHelp': 'For S3-compatible services like MinIO, Wasabi, or Backblaze B2',
  'admin.storage.accessKeyId': 'Access Key ID',
  'admin.storage.secretAccessKey': 'Secret Access Key',
  'admin.storage.leaveBlankToKeep': 'leave blank to keep current',
  'admin.storage.pathPrefix': 'Path Prefix',
  'admin.storage.usePresignedUrls': 'Use presigned URLs for downloads',
  'admin.storage.encryptAtRest': 'Encrypt files at rest (AES-256-GCM)',
  'admin.storage.assignments': 'Storage Assignments',
  'admin.storage.assignmentsDescription': 'Assign storage targets to different purposes',
  'admin.storage.purpose': 'Purpose',
  'admin.storage.currentTarget': 'Current Target',
  'admin.storage.assignTarget': 'Assign Target',
  'admin.storage.localStorage': 'Local Storage',
  'admin.storage.purpose_backup': 'Backups',
  'admin.storage.purpose_backup_desc': 'Automatic and manual backup files',
  'admin.storage.purpose_photos': 'Photos',
  'admin.storage.purpose_photos_desc': 'Trip photos and images',
  'admin.storage.purpose_files': 'Files',
  'admin.storage.purpose_files_desc': 'Trip documents and attachments',
  'admin.storage.purpose_covers': 'Cover Images',
  'admin.storage.purpose_covers_desc': 'Trip cover photos',
  'admin.storage.purpose_avatars': 'Avatars',
  'admin.storage.purpose_avatars_desc': 'User profile pictures',
  'admin.storage.assignmentsNote': 'Important',
  'admin.storage.assignmentsNoteText': 'Changing storage assignments only affects new uploads. Existing files remain in their current location.',
  'admin.storage.applyToAll': 'Apply to all purposes',
  'admin.storage.applyToAllBtn': 'Apply',
  'admin.storage.applyToAllSuccess': 'Storage target applied to all purposes',
