const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'offline.enabled': 'Enable offline mode',
  'offline.description': 'Cache trip data and documents so they are available without an internet connection. Only available in the installed app.',
  ...
  'offline.cachedDocuments': '{count} document(s) cached',
