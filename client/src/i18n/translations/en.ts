const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'packing.processingImage': 'Analyzing image...',
  'packing.startingCamera': 'Starting camera...',
  'packing.qrNoCodeFound': 'No QR code found in this image. Please ensure the QR code is clear, well-lit, and not blurry.',
