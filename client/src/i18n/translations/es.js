const es = {
  ...
  'settings.deleteBlockedMessage': 'Eres el único administrador. Promociona a otro usuario a administrador antes de eliminar tu cuenta.',
  ...
  'login.selfHosted': 'Autohospedado · Código abierto · Tus datos siguen siendo tuyos',
  ...
  'register.subtitle': 'Crea una cuenta y empieza a planificar tus viajes soñados.',
  ...
  'admin.apiKeysHint': 'Opcional. Activa datos ampliados de lugares como fotos y tiempo.',
  ...
  'admin.addons.toast.updated': 'Addon actualizado',
  'admin.addons.toast.error': 'No se pudo actualizar el addon',
  'admin.addons.noAddons': 'No hay addons disponibles',
  ...
  'vacay.blockWeekendsHint': 'Evita registrar vacaciones en sábados y domingos',
  ...
  'vacay.sharingHint': 'Comparte tu plan de vacaciones con otros usuarios de NOMAD',
  'vacay.owner': 'Propietario',
  'vacay.shareEmailPlaceholder': 'Correo del usuario de NOMAD',
  'vacay.shareSuccess': 'Plan compartido correctamente',
  'vacay.shareError': 'No se pudo compartir el plan',
  'vacay.dissolve': 'Disolver fusión',
  ...
  'vacay.fuseInfo3': 'Ambas partes pueden borrar entradas y cambiar el número de días de vacaciones.',
  ...
  'backup.toast.created': 'Copia creada correctamente',
  ...
  'backup.auto.enableHint': 'Se crearán copias automáticamente según el horario elegido',
  ...
  'photos.uploadHint': 'Crea un album compartido para este viaje',
  'photos.clickToSelect': 'o haz clic para seleccionar',
  'photos.dropHere': 'Suelta las fotos aqui...',
  'photos.dropTitle': 'Suelta las fotos aqui',
  'photos.fileHint': 'JPG, PNG, GIF, WebP · max. 10 MB · hasta 30 fotos',
  'photos.selectedCount': '{count} foto(s) seleccionada(s)',
  'photos.sharedAlbum': '{count} recuerdos en este album compartido',
  'photos.sharedAlbumFor': '{count} recuerdos en {trip}',
  'photos.allPlaces': 'Todos los lugares',
  'photos.view.grid': 'Cuadricula',
  'photos.view.day': 'Por dia',
  'photos.view.place': 'Por lugar',
  'photos.stats.total': 'Fotos',
  'photos.stats.days': 'Dias',
  'photos.stats.places': 'Lugares',
  'photos.stats.latest': 'Ultima subida',
  'photos.sectionCount': '{count} foto(s)',
  'photos.ungrouped': 'Sin clasificar',
  'photos.featured': 'Recuerdo destacado',
  'photos.coverFallback': 'Portada del album compartido',
  'photos.coverHint': 'Un destaque visual de este album de viaje',
  ...
  'photos.addCaption': 'Anadir un pie de foto...',
  'photos.uploadN': 'Subida de {n} foto(s)',
  'admin.addons.catalog.memories.name': 'Recuerdos',
  'admin.addons.catalog.memories.description': 'Albumes de fotos compartidos para cada viaje',
