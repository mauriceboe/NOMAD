const nl: Record<string, string> = {
  ...
  // Storage
  'admin.storage.title': 'Opslagdoelen',
  'admin.storage.description': 'Configureer externe opslagbackends voor back-ups, bestanden en media',
  'admin.storage.addTarget': 'Opslagdoel toevoegen',
  'admin.storage.editTarget': 'Opslagdoel bewerken',
  'admin.storage.name': 'Naam',
  'admin.storage.type': 'Type',
  'admin.storage.status': 'Status',
  'admin.storage.encryption': 'Versleuteling',
  'admin.storage.enabled': 'Ingeschakeld',
  'admin.storage.disabled': 'Uitgeschakeld',
  'admin.storage.encrypted': 'Versleuteld',
  'admin.storage.unencrypted': 'Niet versleuteld',
  'admin.storage.test': 'Test',
  'admin.storage.testing': 'Testen...',
  'admin.storage.testSuccess': 'Verbinding geslaagd',
  'admin.storage.testFailed': 'Verbinding mislukt',
  'admin.storage.confirmDelete': 'Opslagdoel "{name}" verwijderen? Dit zal mislukken als het doel momenteel is toegewezen.',
  'admin.storage.noTargets': 'Geen opslagdoelen geconfigureerd',
  'admin.storage.bucket': 'S3 Bucket',
  'admin.storage.region': 'Regio',
  'admin.storage.endpoint': 'Aangepast eindpunt',
  'admin.storage.endpointHelp': 'Voor S3-compatibele services zoals MinIO, Wasabi of Backblaze B2',
  'admin.storage.accessKeyId': 'Toegangssleutel-ID',
  'admin.storage.secretAccessKey': 'Geheime toegangssleutel',
  'admin.storage.leaveBlankToKeep': 'laat leeg om huidige te behouden',
  'admin.storage.pathPrefix': 'Padvoorvoegsel',
  'admin.storage.usePresignedUrls': 'Gebruik vooraf ondertekende URL\'s voor downloads',
  'admin.storage.encryptAtRest': 'Versleutel bestanden in rust (AES-256-GCM)',
  'admin.storage.assignments': 'Opslag toewijzingen',
  'admin.storage.assignmentsDescription': 'Wijs opslagdoelen toe aan verschillende doeleinden',
  'admin.storage.purpose': 'Doel',
  'admin.storage.currentTarget': 'Huidig doel',
  'admin.storage.assignTarget': 'Doel toewijzen',
  'admin.storage.localStorage': 'Lokale opslag',
  'admin.storage.purpose_backup': 'Back-ups',
  'admin.storage.purpose_backup_desc': 'Automatische en handmatige back-upbestanden',
  'admin.storage.purpose_photos': 'Foto\'s',
  'admin.storage.purpose_photos_desc': 'Reisfoto\'s en afbeeldingen',
  'admin.storage.purpose_files': 'Bestanden',
  'admin.storage.purpose_files_desc': 'Reisdocumenten en bijlagen',
  'admin.storage.purpose_covers': 'Omslagafbeeldingen',
  'admin.storage.purpose_covers_desc': 'Reis omslagfoto\'s',
  'admin.storage.purpose_avatars': 'Avatars',
  'admin.storage.purpose_avatars_desc': 'Gebruikersprofielafbeeldingen',
  'admin.storage.assignmentsNote': 'Belangrijk',
  'admin.storage.assignmentsNoteText': 'Het wijzigen van opslag toewijzingen heeft alleen invloed op nieuwe uploads. Bestaande bestanden blijven op hun huidige locatie.',
  'admin.storage.applyToAll': 'Toepassen op alle doeleinden',
  'admin.storage.applyToAllBtn': 'Toepassen',
  'admin.storage.applyToAllSuccess': 'Opslagbestemming toegepast op alle doeleinden',
