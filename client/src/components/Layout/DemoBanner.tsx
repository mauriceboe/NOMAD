...
const texts: Record<string, DemoTexts> = {
  ...
  es: {
    ...
    addonsTitle: 'Addons modulares (se pueden desactivar en la versión completa)',
    addons: [
      ['Vacay', 'Planificador de vacaciones con calendario, festivos y fusión de usuarios'],
      ['Atlas', 'Mapa del mundo con países visitados y estadísticas de viaje'],
      ['Equipaje', 'Listas de control por viaje'],
