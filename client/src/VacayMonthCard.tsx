        ...
        {weeks.map((week, wi) => (
          <div key={wi} className="grid grid-cols-7">
            {week.map((day, di) => {
              ...
              const isCompany =
                companyHolidaysEnabled && companyHolidaySet.has(dateStr);
              const dayEntries = entryMap[dateStr] || [];
              const isBlocked =
                !!holiday ||
                (weekend && blockWeekends) ||
              ...
              return (
                <div
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background = weekend
                      ? "var(--bg-secondary)"
                      : "transparent";
                  }}
                >
                  ...
                  {dayEntries.length === 1 && (
                    <div
                      className="absolute inset-0.5 rounded"
                      style={{
                        backgroundColor: dayEntries[0].person_color,
                        opacity: 0.4,
                      }}
                    />
                  )}
                  ...
                  {dayEntries.length === 3 && (
                    <div
                      className="absolute inset-0.5 rounded overflow-hidden"
                      style={{ opacity: 0.4 }}
                    >
                      <div
                  ...
                  <span
                    className="relative z-[1] text-[11px] font-medium"
                    style={{
                      color: holiday
                        ? holiday.color
                        : weekend
